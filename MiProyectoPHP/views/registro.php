            ...
            <div class="col s12 m6 l4 offset-l4 offset-m3">
                <form action="" method="get">
                    <div class="row card-panel z-depth-4">
                        ...
                        <div class="input-field col s12">
                            <i class="material-icons prefix">lock</i>
                            <input type="password" placeholder="Confirmar contraseña" id="password" name="password" class="validate" required/>
                        </div>
                        <button class="btn green right"><i class="material-icons left">send</i>Enviar</button>
                    </div>
                </form>
            </div>
        </div>
